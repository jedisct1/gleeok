...
def prf128(x, k):
    ...
    #print(bits2hex(b0), bits2hex(rk0[0]))
    #print(bits2hex(b1), bits2hex(rk1[0]))
    #print(bits2hex(b2), bits2hex(rk2[0]))

    for i in range(1, R+1):
        #print(i)
        #print(bits2hex(b0), bits2hex(rk0[i]), bits2hex(rc128[0][i]))
        #print(bits2hex(b1), bits2hex(rk1[i]), bits2hex(rc128[1][i]))
        #print(bits2hex(b2), bits2hex(rk2[i]), bits2hex(rc128[2][i]))
...
# x = int2bits(0xE3E70682C2094CAC629F6FBED82C07CD, N)
# k = int2bits(0x82E2E662F728B4FA42485E3A0A5D2F3482E2E662F728B4FA42485E3A0A5D2F34, K)
# y = prf128(x, k)
#print(0)
#print(bits2hex(x))
#print(bits2hex(k))
